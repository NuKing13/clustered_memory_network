...
class Network:
    ...
    def build_reservoir(self, inhibition=None):
        ...
        # EI, II, IE
        # fixed indegrees
        K_EI = int(self.rho * self.N_E)
        K_IE = int(self.rho * self.N_I)
        K_II = int(self.rho * self.N_I)
        conn_params_EI = {
            "rule": "fixed_indegree",
            "indegree": K_EI,
    ...
    def bg_noise(self, t_sim, t_start=1000.0):
        ...
        nest.SetStatus(
            self.bg_neurons,
            {"rate": self.inp_rate * self.rho * self.N_E, "start": t_start},
    ...
    def poisson_inp(self, inp_seq, inp_str, tstep, scale_std, n_cl):
        ...
        nest.SetStatus(
            self.bg_neurons,
            {"rate": self.inp_rate * self.rho * self.N_E, "start": 1000.0},
